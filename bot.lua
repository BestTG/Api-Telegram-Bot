...
----config----
local bot_api_key = "263250676:AAG67lQtXc7IhnMg3g8FwPgWkdHYTgzsWvg"--توکن بوت را درون " قرار دهید --
...
function is_admin(msg)-- Check if user is admin or not
  local var = false
  local admins = {32347781}-- put your id here
...
elseif msg.text:match("^/[sS]tart") or msg.text:match("^/[Hh]elp") then
 sendMessage(msg.chat.id, start, true, false, true)
  sendMessage(msg.chat.id, [[[ربات خودتونو بسازید :)](http://telegram.me/PmResan)]], true, false, true)
return end
